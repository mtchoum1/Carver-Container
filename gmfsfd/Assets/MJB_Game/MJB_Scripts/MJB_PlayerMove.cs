...
public class MJB_PlayerMove : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        //need to get mouse position and aim direction (screen to world point stuff)

        // fieldOfView.SetAimDirection(aimDir);
        // fieldOfView.SetOrigin(transform.position); //set origin in player update, actually implement the change in late update in field of view script
