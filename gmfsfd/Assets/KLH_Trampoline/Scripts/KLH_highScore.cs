...
public class KLH_highScore : MonoBehaviour
{
    ...
    public void ShowScores(){
        ...
        scores = File.ReadAllLines("./Assets/KLH_Trampoline/KLH_playerScores.txt").ToList();
        ...
        FileStream fs = new FileStream("./Assets/KLH_Trampoline/KLH_playerScores.txt", FileMode.Create, FileAccess.Write);  
